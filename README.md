...
## 🧪 Testing & Demo Streams

For testing and demonstration purposes, the dynamic media components and ExoPlayer integration are pre-configured to utilize the following test video URLs:
* **Live News Stream (HLS):** `https://feeds.intoday.in/aajtak/api/aajtakhd/master.m3u8`
* **VOD Video (MP4):** `https://storage.googleapis.com/exoplayer-test-media-0/BigBuckBunny_320x180.mp4`
